<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-primary">Estilo de botones</h3> </div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-title">
                <h4>Botones predeterminados </h4>

            </div>
            <div class="button-list">
                <p class="text-muted m-b-15">
                    Use the button classes on an <code>&lt;a&gt;</code>, <code>&lt;button&gt;</code>, or <code>btn-outline</code> element.
                </p>
