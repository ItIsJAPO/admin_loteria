...
(function (factory) {
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            ...
            toggleheader:'<i class="fas fa-arrows-alt"></i>',
            fullscreen: '<i class="fas fa-expand"></i>',
            borderless: '<i class="far fa-window-restore"></i>',
        ...
        msgValidationErrorIcon: '<i class="fas fa-exclamation-triangle"></i> ',
    ...
    $(document).ready(function () {
        ...
        $('body').on('click','.btn-close',function(e){
            e.preventDefault();
            $('#kvFileinputModal').parents('.modal-backdrop').remove();
            setTimeout(function () {$('#kvFileinputModal').remove();},1000);
        });
