    ...
    <div class="error-page" id="wrapper">
        <div class="error-box">
            <div class="error-body text-center">
                <h1>403</h1>
                <h3 class="text-uppercase">ACCESO NO AUTORIZADO! </h3>

                <p class="text-muted m-t-30 m-b-30">No tiene los permisos necesarios para acceder a esta sección o su sesión ha expirado.</p>
