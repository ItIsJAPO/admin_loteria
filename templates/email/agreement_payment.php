        ...
        <tr>
            <td class = "cell_view text-center">
                <div style = "margin-bottom: 30px">
                    <h2> <b class = "text-uppercase"> <?= _("Pago de suscripcion exitoso") ?> </b> </h2>
                </div>
                ...
                <div class = "form-group">
                    <p>
                        <?=
                            sprintf(
                                _("El pago de su suscripcion al curso: %s se ha realizado correctamente"),
                                '<b>' . $course . '</b>'
                            )
                        ?>
                    </p>
